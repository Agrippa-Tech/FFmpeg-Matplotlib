...
for i in range(num_estrelas):
    ax.plot(
        ...
        "o",
        color="white",
        markersize=estrelas_tamanhos[i],
        alpha=estrelas_brilho[i],
        zorder=1,
    )
...
ax.text(0, 3.8, "Sol", color="white", fontsize=12, ha="center", zorder=101)
...
for planeta in planetas_dados:
    ...
    if planeta["epiciclo1_raio"] > 0:
        epiciclo1 = plt.Circle(
            (0, 0),
            planeta["epiciclo1_raio"],
            color=planeta["cor"],
            fill=False,
            alpha=0.4,
            linewidth=2,
    ...
    if planeta["epiciclo2_raio"] > 0:
        epiciclo2 = plt.Circle(
            (0, 0),
            planeta["epiciclo2_raio"],
            color=planeta["cor"],
            fill=False,
            alpha=0.4,
            linewidth=1.5,
...
epiciclo_lua = plt.Circle(
    (0, 0),
    lua_dados["epiciclo_raio"],
    color=lua_dados["cor"],
    fill=False,
    alpha=0.3,
    linewidth=2,
...
orbita_lua = plt.Circle(
    (0, 0),
    lua_dados["raio_orbital"],
    color=lua_dados["cor"],
    fill=False,
    alpha=0.3,
    linewidth=1.5,
...
# Criar label da Lua
label_lua = ax.text(
    0, 0, "Lua", color="white", fontsize=8, ha="center", va="bottom", zorder=60
)
...
def update(frame):
    ...
    for i, planeta in enumerate(planetas_dados):
        ...
        if planeta["epiciclo1_raio"] > 0:
            ...
            angulo_epiciclo1 = (
                fases_iniciais_epiciclo1[i] + planeta["epiciclo1_vel"] * frame
            )

            # Posição do centro do segundo epiciclo no primeiro epiciclo
            x_epiciclo1 = x_deferente + planeta["epiciclo1_raio"] * np.cos(
                angulo_epiciclo1
            )
            y_epiciclo1 = y_deferente + planeta["epiciclo1_raio"] * np.sin(
                angulo_epiciclo1
            )
            ...
            angulo_epiciclo2 = (
                fases_iniciais_epiciclo2[i] + planeta["epiciclo2_vel"] * frame
            )

            # Posição final: centro do segundo epiciclo + deslocamento no segundo epiciclo
    ...
    x_centro_epiciclo = x_terra_final + lua_dados["raio_orbital"] * np.cos(
        angulo_lua_def
    )
    y_centro_epiciclo = y_terra_final + lua_dados["raio_orbital"] * np.sin(
        angulo_lua_def
    )
